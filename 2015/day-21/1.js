    ...
    for (var armor = 0; armor < ARMOR.length; armor++) {
      for (var ring1 = 0; ring1 < RINGS.length; ring1++) {
        for (var ring2 = 0; ring2 < RINGS.length; ring2++) {
          ...
          if (fight(createPlayer(equipment), enemy)) {
...
module.exports = (input) => getMinimumGoldToWin(createEnemy(input));
module.exports.getMinimumGoldToWin = getMinimumGoldToWin;
